            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
					...
					for(var i=0; i < h.length; i++){
						if(h[i].indexOf('background-color') == -1){
							g+=h[i];
						}else{
							if(u.htmlEscape(d.miscProps.eventColor) != '' && u.htmlEscape(d.miscProps.eventColor) != null && u.htmlEscape(d.miscProps.eventColor) != 'undefined') g+= 'background-color:'+u.htmlEscape(d.miscProps.eventColor)+';color:'+u.htmlEscape(d.miscProps.eventTextColor)+';';
						}
					}
					if(g == '') g+= 'background-color:'+u.htmlEscape(d.miscProps.eventColor)+';color:'+u.htmlEscape(d.miscProps.eventTextColor)+';';
					console.log(g);
					console.log(d);
